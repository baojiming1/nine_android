...
public class RecyclerViewStateUtils {
     ...
     */
    public static void setFooterViewState(Context mContext, RecyclerView recyclerView, int pageSize, LoadingFooter.State state, View.OnClickListener errorListener) {
